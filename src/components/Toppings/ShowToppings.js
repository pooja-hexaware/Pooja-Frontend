...
import { setSelectedToppingsList, setToppingsPrice } from 'components/MenuList/store/dataslice'
import React, { useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'

function ShowToppings(props) {
                ...
                onClose={()=>{
                    ...
                    props.toppings_list.map((eachtopping, index) => {
                        if (checked.includes(index)) {
                            ...
                            listOfToppings.push({name:eachtopping.name,price:eachtopping.price,menuId:currentSelectedMenuId})
                        }
                    })
